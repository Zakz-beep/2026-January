...
export default function PostArticle() {
  ...
  useEffect(() => {
    const fetchArticleData = async () => {
      try {
        ...
        // If there's an ID, fetch article data for editing
        if (id) {
  ...
  // Handle form submission (UPDATE existing article)
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1 hidden sm:block">
                {id ? "Update your existing content" : "Create and publish your news content"}
              </p>
            </div>
          </div>
      ...
      <AnimatePresence>
        {showPreview && (
          ...
          >
            ...
            <div className={`mx-auto py-12 px-6 transition-all ${
              previewDevice === "mobile" 
                ? "max-w-[375px] border-x min-h-screen shadow-2xl" 
                : "max-w-4xl"
            }`}>
              ...
              {featuredImage && (
                <img 
                  src={featuredImage} 
                  className="w-full aspect-video object-cover rounded-[32px] mb-8 shadow-xl" 
                  alt="Featured" 
                />
              )}
              <div 
