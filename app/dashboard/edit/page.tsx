...
const [uploadMethod, setUploadMethod] = useState<"url" | "upload">("upload");
  ...
  // 1. Ambil Data Artikel yang Mau Diedit
  useEffect(() => {
    const fetchArticleData = async () => {
      try {
        ...
        // Set semua state dengan data lama
  ...
  const handleUpdate1 = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    if (fetching) return <div className="flex h-screen items-center justify-center">Loading data...</div>;
  ...
  return (
    <div className="min-h-screen bg-background relative">
      <div className="container max-w-6xl mx-auto px-4 py-6 md:py-8">
        ...
        <form onSubmit={handleUpdate1} className="space-y-6">
